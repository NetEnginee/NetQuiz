...
<head>
    ...
    <title>403 - Akses Ditolak | NetQuiz</title>
...
<body class="error-page-body theme-403">
    ...
    <div class="error-panel-card">
        ...
        <div class="error-status-badge">
            ...
            <span>STATUS: ERR_FIREWALL_DROP_POLICY</span>
        </div>

        <!-- 8-Bit Glowing Error Number -->
        <div class="error-huge-code">403</div>

        <!-- Title & Subtitle -->
        <h1 class="error-main-heading">
            Akses Ditolak oleh Firewall Filter
        </h1>
        <p class="error-main-desc">
            Paket kamu di-drop oleh keamanan NetQuiz. Kamu tidak memiliki izin untuk mengakses bagian ini.
        </p>

        <!-- CLI Context Box -->
        <div class="error-cli-box">
            <span class="error-cli-prompt">[admin@netquiz] &gt;</span>
            <span class="error-cli-text">/ip firewall filter add chain=input action=drop comment="unauthorized"</span>
        </div>
        ...
        <div class="error-actions-group">
            ...
            <a href="<?= defined('BASE_URL') ? BASE_URL : '/' ?>/logout" class="btn-pixel-secondary">
        ...
        <div class="error-footer-hint">
            Tip: Hubungi administrator apabila Anda memerlukan hak akses tambahan.
        </div>
    </div>
